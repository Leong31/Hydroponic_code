...
const char* ssid = "WIFI_SSID"; //put wifi name
const char* password = "WIFI_PASSWORD"; //put wifi password
const char* mqtt_server = "IP_ADDRESS"; // ping 'broker.hivemq.com' or 'test.mosquitto.org' on cmd
...
void setup() {
  pinMode(BUILTIN_LED, OUTPUT);  // LED for MQTT feedback
